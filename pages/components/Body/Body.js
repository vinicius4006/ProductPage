...
export default function Body() {
  ...
  lg:text-5xl text-center lg:text-left mb-6"  
            >
              ...
              Todos os atendentes em um só lugar
            </h2>
            
            <p className="text-gray-500 text-lg text-center lg:text-left mb-6">
              Com o ViaChat você coloca quantos operadores quiser atendendo
              simultaneamente em vários canais de atendimento em um único lugar.
            </p>
